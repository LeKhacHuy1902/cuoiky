...
<body>
    ...
    <!-- tiêu chuẩn bảo dưỡng -->
     <section class="tieu-chuan">
        ...
        <P>Tại (trang web), chúng tôi nghiên cứu và phát triển mô hình bảo dưỡng chăm sóc xe ô tô, xe máy tại nhà toàn diện, chất lượng cao với 3 tiêu chí sau:
        </P>
        <ul>
            <li>Quy trình: được kiểm soát nghiêm ngặt và tuân theo đúng các giai đoạn đã thiết lập.</li>
            <li>Đội ngũ kỹ thuật viên: được đào tạo bài bản, tuân thủ từng các nguyên tác khi tực hiện các dịch vụ bảo dưỡng chăm sóc xe tại nhà.</li>
    ...
    <section class="danh-sach-dich-vu">
        ...
        <div class="tu-van">
            ...
            <hr>
            <ul>
                <li>Cách chăm sóc ngoại nội thất xe ô tô: Rửa xe, tẩy ố kính, bụi sắt, nhựa đường, loại bỏ mùi hôi, nấm mốc,…</li>
